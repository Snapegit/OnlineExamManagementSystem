...
<template>
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<div class="btn_view">
					...
					<el-button type="warning" @click="echartClick1" v-if="btnAuth('chengjixinxi','考试情况统计')">考试情况统计</el-button>
				</div>
			</div>
			<br>
			<el-table
		...
		<!-- 统计图弹窗 -->
		<el-dialog v-model="echartVisible" :title="'考试情况统计'" width="70%">
...
<script setup>
	...
	const echartClick1 = ()=>{
		...
		nextTick(()=>{
			...
			context?.$http({
				url: "chengjixinxi/sectionStat/kaoshichengji/shijuanmingcheng",
				method: 'get'
			}).then(res=>{
                ...
                for(let i=0;i<obj.length;i++){
                    xAxis.push(obj[i].shijuanmingcheng);
                    yAxis1.push(parseFloat((obj[i].不及格)));
                    yAxis2.push(parseFloat((obj[i].及格)));
                    yAxis3.push(parseFloat((obj[i].良好)));
                    yAxis4.push(parseFloat((obj[i].优秀)));
                    pArray.push({
